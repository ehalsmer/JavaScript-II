...
getLength(items, arrayLength => console.log(arrayLength));
...
sumNums(24, 7, sum => console.log(sum));
...
contains('Gum', items, result => console.log(result)); // Returns true because Gum is in items array.
contains('Pen', items, result => console.log(result)); // Returns false
